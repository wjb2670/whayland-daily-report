  ...
  async showLogin() {
            ...
            <div class="login-container">
                <div class="login-card">
                    <div class="whayland-logo">
                        <img src="assets/whayland-logo.png" alt="Whayland Logo" class="logo-img" style="max-width:180px;max-height:80px;height:auto;width:auto;object-fit:contain;" />
                    </div>
    ...
    style.textContent = `
            ...
            #signInButton {
                ...
                border: none;
                border-radius: 6px;
                box-shadow: 0 2px 6px rgba(38,38,102,0.08);
                font-weight: 600;
